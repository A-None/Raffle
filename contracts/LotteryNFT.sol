...
contract LotteryNFT is ERC721, Ownable {
    ...
    constructor() public ERC721("anone Lottery Ticket", "RLT") {}

    function newLotteryItem(address player, uint8[4] memory _lotteryNumbers, uint256 _amount, uint256 _issueIndex, uint256 _purchaseDate)
        public onlyOwner
        returns (uint256)
    {
        tokenIds.increment();
        ...
        purchaseDate[newItemId] = _purchaseDate;
